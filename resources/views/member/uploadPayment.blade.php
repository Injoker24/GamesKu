...
@section('title', trans('up_payment.title'))
...
@section('container')
    ...
    <div class="transaction-detail-container">
        ...
        <div class="transaction-fill-container p-5" style="border-radius: 40px">
            <div class="d-flex mb-4">
                ...
                <div class="info-detail d-flex flex-column" style="justify-content: center;">
                    ...
                    <div class="d-flex mb-1" style="width: 350px; justify-content: space-between; align-items: center;">
                        <div>
                            <span class="fw-bolder">@lang('up_payment.tr_id')</span>
                        </div>
                    ...
                    <div class="d-flex mb-1" style="width: 350px; justify-content: space-between; align-items: center;">
                        <div>
                            <span class="fw-bolder">@lang('up_payment.user_email')</span>
                        </div>
                        <div style="width: 200px;">
                    ...
                    <div class="d-flex mb-1" style="width: 350px; justify-content: space-between; align-items: center;">
                        <div>
                            <span class="fw-bolder">@lang('up_payment.date_time')</span>
                        </div>
                        <div style="width: 200px;">
                    ...
                    <div class="d-flex mb-1" style="width: 350px; justify-content: space-between; align-items: center;">
                        <div>
                            <span class="fw-bolder">@lang('up_payment.paym_stat')</span>
                        </div>
                        <div style="width: 200px;">
            ...
            <div class="transaction-detail-item">
                <h5 style="font-weight: bold; ">@lang('up_payment.paym_method')</h5>
            ...
            <div class="d-flex justify-content-center">
                <div class="transaction-detail-due">
                    <h5>@lang('up_payment.pay_bfr') <span style="color: var(--accent);">{{ $trDetail->due_date }}</span></h5>
                </div>
            </div>
            <form action="/transaction/{{ $trDetail->id }}/upload" method="POST" enctype="multipart/form-data" class="mt-2 container submit-payment-container">
                @csrf
                <label for="formFile" class="form-label" style="font-weight: bold; font-size: 20px;">@lang('up_payment.up_prf')</label>
                ...
                @endif
                <button class="upload-payment-button" type="submit">@lang('up_payment.submit_paym')</button>
            </form>
        </div>
    </div>
